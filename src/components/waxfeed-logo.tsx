...
export function WaxfeedLogo({ className = "", size = "md" }: { className?: string; size?: "sm" | "md" | "lg" }) {
  ...
  // Full MiniDisc-style logo with only the vinyl disc spinning
  return (
    <svg
      width={dimension}
      height={dimension}
    ...
    >
      <defs>
        ...
        {/* CASE GRADIENTS - darker/transparent for dark backgrounds */}
        ...
        <filter id="mainShadow" x="-15%" y="-15%" width="135%" height="140%">
          <feDropShadow dx="5" dy="8" stdDeviation="10" floodColor="#000000" floodOpacity="0.5"/>
        </filter>
      </defs>

      {/* CASE STRUCTURE - dark version */}
      <g filter="url(#mainShadow)">
        <rect x="28" y="28" width="444" height="444" rx="10" fill="url(#caseMain)"/>
      </g>

      {/* Case outer bevel - subtle on dark */}
      <path d="M38,28 L462,28 Q472,28 472,38 L472,32 Q472,28 462,28 L38,28 Q28,28 28,38 L28,32" fill="#505050" opacity="0.5"/>
      <path d="M28,38 L28,462 Q28,472 38,472 L32,472 Q28,472 28,462 L28,38 Q28,28 38,28 L32,28" fill="#404040" opacity="0.4"/>
      <path d="M38,472 L462,472 Q472,472 472,462 L472,468 Q472,472 462,472 L38,472 Q28,472 28,462 L28,468" fill="#000000" opacity="0.3"/>
      <path d="M472,38 L472,462 Q472,472 462,472 L468,472 Q472,472 472,462 L472,38 Q472,28 462,28 L468,28" fill="#000000" opacity="0.25"/>
      ...
      {/* Case wall ridges - darker */}
      <rect x="35" y="80" width="4" height="340" fill="#2a2a2a" rx="1"/>
      <rect x="35" y="80" width="1" height="340" fill="#3a3a3a"/>
      <rect x="461" y="80" width="4" height="340" fill="#1a1a1a" rx="1"/>
      <rect x="464" y="80" width="1" height="340" fill="#101010"/>
      <rect x="80" y="35" width="340" height="4" fill="#303030" rx="1"/>
      <rect x="80" y="35" width="340" height="1" fill="#404040"/>
      <rect x="80" y="461" width="340" height="4" fill="#101010" rx="1"/>
      <rect x="80" y="464" width="340" height="1" fill="#0a0a0a"/>

      {/* CORNER SCREW MOUNTS - darker */}
      <g transform="translate(58, 58)">
        <circle cx="0" cy="0" r="12" fill="#2a2a2a"/>
        <circle cx="0" cy="0" r="10" fill="#222222"/>
        <circle cx="0" cy="0" r="8" fill="#2a2a2a"/>
        <circle cx="0" cy="0" r="6" fill="#1a1a1a"/>
        <circle cx="0" cy="0" r="4" fill="#151515"/>
        <circle cx="0" cy="0" r="2" fill="#101010"/>
        <ellipse cx="-3" cy="-3" rx="3" ry="2" fill="#ffffff" opacity="0.15" transform="rotate(-45)"/>
      </g>

      <g transform="translate(442, 58)">
        <circle cx="0" cy="0" r="12" fill="#282828"/>
        <circle cx="0" cy="0" r="10" fill="#202020"/>
        <circle cx="0" cy="0" r="8" fill="#282828"/>
        <circle cx="0" cy="0" r="6" fill="#181818"/>
        <circle cx="0" cy="0" r="4" fill="#131313"/>
        <circle cx="0" cy="0" r="2" fill="#0e0e0e"/>
        <ellipse cx="-3" cy="-3" rx="3" ry="2" fill="#ffffff" opacity="0.1" transform="rotate(-45)"/>
      </g>

      <g transform="translate(58, 442)">
        <circle cx="0" cy="0" r="12" fill="#222222"/>
        <circle cx="0" cy="0" r="10" fill="#1a1a1a"/>
        <circle cx="0" cy="0" r="8" fill="#222222"/>
        <circle cx="0" cy="0" r="6" fill="#141414"/>
        <circle cx="0" cy="0" r="4" fill="#101010"/>
        <circle cx="0" cy="0" r="2" fill="#0a0a0a"/>
        <ellipse cx="-2" cy="-2" rx="2.5" ry="1.5" fill="#ffffff" opacity="0.08" transform="rotate(-45)"/>
      </g>

      <g transform="translate(442, 442)">
        <circle cx="0" cy="0" r="12" fill="#202020"/>
        <circle cx="0" cy="0" r="10" fill="#181818"/>
        <circle cx="0" cy="0" r="8" fill="#202020"/>
        <circle cx="0" cy="0" r="6" fill="#121212"/>
        <circle cx="0" cy="0" r="4" fill="#0e0e0e"/>
        <circle cx="0" cy="0" r="2" fill="#080808"/>
        <ellipse cx="-2" cy="-2" rx="2.5" ry="1.5" fill="#ffffff" opacity="0.06" transform="rotate(-45)"/>
      </g>

      {/* VINYL DISC - THIS SPINS */}
      ...
      {/* SHUTTER MECHANISM - static, doesn't spin */}
      ...
      <g transform="translate(68, 398)">
        <rect x="0" y="0" width="36" height="28" fill="none" stroke="#505050" strokeWidth="1.5" rx="3"/>
        <rect x="2" y="2" width="32" height="24" fill="none" stroke="#606060" strokeWidth="0.5" rx="2"/>
        <text x="18" y="19"
              fontFamily="Helvetica Neue, Helvetica, Arial, sans-serif"
              fontSize="12"
              fontWeight="700"
      ...
      {/* CASE SURFACE REFLECTIONS - subtle on dark */}
      <polygon points="28,140 140,28 200,28 28,220" fill="#ffffff" opacity="0.03"/>
      <polygon points="28,280 60,28 80,28 28,310" fill="#ffffff" opacity="0.02"/>
    </svg>
  )
}
