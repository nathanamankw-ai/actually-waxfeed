    ...
    <div className="flex flex-wrap items-center gap-2">
      {visibleLinks.map((link) => (
        <a
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium transition-all no-underline border border-gray-300 hover:border-[#555] bg-gray-50 hover:bg-gray-200"
      ...
      {hasMore && !expanded && (
        <button
          ...
          className="px-3 py-1.5 text-xs text-gray-500 border border-gray-300 hover:border-[#555] hover:text-black transition-colors"
        >
          +{links.length - 3} more
        </button>
      )}
