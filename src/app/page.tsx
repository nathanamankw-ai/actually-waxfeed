...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
        ...
        <div className="max-w-6xl mx-auto px-6 py-20 lg:py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8">
              Discover Music.
              <br />
              <span className="text-[#888]">Connect Through Sound.</span>
              <br />
              <span className="text-[#ffd700]">Earn Rewards.</span>
            </h1>
            
            <p className="text-lg text-[#aaa] mb-10 max-w-xl leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {!session ? (
                <>
                  ...
                  <Link
                    href="/discover"
                    className="px-8 py-4 border-2 border-[#444] text-sm font-bold uppercase tracking-wider hover:border-white transition-colors text-center"
                  >
                    Explore Albums
                  </Link>
                </>
      ...
      <section className="border-b border-[#222] bg-[#0d0d0d]">
        <div className="max-w-6xl mx-auto px-6 py-16 lg:py-20">
          <p className="text-xs tracking-[0.3em] uppercase text-[#666] mb-12 text-center">
            Three Revolutionary Features
          </p>
          
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {/* PILLAR 1: GAMIFY */}
            <Link href="/quick-rate" className="group block p-8 border-2 border-[#222] hover:border-[#ffd700] transition-colors bg-[#111]">
              ...
              <div className="flex items-center gap-4 text-sm">
                ...
                <span className="text-[#888]">WAX Rewards</span>
              </div>
            </Link>
            
            {/* PILLAR 2: CONNECT */}
            <Link href="/discover/connections" className="group block p-8 border-2 border-[#222] hover:border-[#00ff88] transition-colors bg-[#111]">
              ...
              <div className="flex items-center gap-4 text-sm">
                ...
                <span className="text-[#666]">|</span>
                <span className="text-[#888]">Music Circles</span>
              </div>
            </Link>
            
            {/* PILLAR 3: DISCOVER */}
            <Link href="/discover" className="group block p-8 border-2 border-[#222] hover:border-[#00bfff] transition-colors bg-[#111]">
              ...
              <div className="flex items-center gap-4 text-sm">
                ...
                <span className="text-[#666]">|</span>
                <span className="text-[#888]">TasteID</span>
              </div>
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-8">
          <div className="flex flex-wrap justify-center gap-12 lg:gap-20">
            <div className="text-center">
              ...
              <p className="text-xs tracking-widest uppercase text-[#666] mt-1">Albums</p>
            </div>
            <div className="text-center">
              <p className="text-3xl lg:text-4xl font-bold tabular-nums">{stats.reviewCount.toLocaleString()}</p>
              <p className="text-xs tracking-widest uppercase text-[#666] mt-1">Ratings</p>
            </div>
            <div className="text-center">
              <p className="text-3xl lg:text-4xl font-bold tabular-nums">{stats.userCount.toLocaleString()}</p>
              <p className="text-xs tracking-widest uppercase text-[#666] mt-1">Members</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-4 sm:grid-cols-5 lg:grid-cols-10 gap-3">
            {billboardAlbums.slice(0, 20).map((album) => (
              <Link
                ...
                className="group"
              >
                <div className="aspect-square w-full bg-[#181818] overflow-hidden relative">
                  {album.coverArtUrl && (
                    <img
                ...
                <p className="text-[11px] font-medium truncate mt-2 group-hover:text-[#888] transition-colors">
                  {album.title}
                </p>
      ...
      <section className="border-b border-[#222]">
        <div className="max-w-6xl mx-auto px-6 py-12 lg:py-16">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/reviews" className="text-sm text-[#888] hover:text-white transition-colors">
              View All →
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {recentReviews.map((review) => (
              <Link
                ...
                className="group flex gap-4 p-4 border border-[#222] hover:border-[#444] transition-colors"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="text-xs text-[#444]" suppressHydrationWarning>
      ...
      {/* FINAL CTA */}
      <section className="bg-gradient-to-b from-[#0a0a0a] to-[#111]">
      ...
      <footer className="border-t border-[#222]">
        <div className="max-w-6xl mx-auto px-6 py-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              <p className="text-sm text-[#666]">WAXFEED · Polarity Lab LLC · 2025</p>
              <p className="text-xs text-[#444] mt-1">The platform that proves your music taste.</p>
            </div>
            <nav className="flex flex-wrap gap-6">
              <Link href="/discover" className="text-sm text-[#666] hover:text-white transition-colors">Discover</Link>
              <Link href="/trending" className="text-sm text-[#666] hover:text-white transition-colors">Trending</Link>
              <Link href="/pricing" className="text-sm text-[#666] hover:text-white transition-colors">Pricing</Link>
