  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <section className="mb-12">
        <h2 className="text-xl font-bold mb-4 text-gray-500">Official Waxfeed Logo</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-500">Adapts to light/dark mode</p>
          </div>
          <div className="border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-500">For dark backgrounds</p>
          </div>
          <div className="border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-500">For light backgrounds</p>
          </div>
        </div>
      </section>
      ...
      {/* Vinyl Logos */}
      <section className="mb-12">
        <h2 className="text-xl font-bold mb-4 text-gray-500">Vinyl Record Variants</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Black & White Vinyl */}
          <div className="border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-500">Simple vinyl record icon</p>
          </div>
          ...
          <div className="border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-500">RGB striped variant</p>
          </div>
          ...
          <div className="border border-gray-200 p-6">
            ...
            <p className="text-sm text-gray-500 mt-4">Interactive 3D vinyl record</p>
          </div>
        </div>
      </section>
